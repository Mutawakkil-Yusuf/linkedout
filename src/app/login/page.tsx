...
export default function LoginPage() {
  ...
  return (
    <div className="mx-auto max-w-[40rem] px-4 py-10 sm:px-5 sm:py-14">
      <header className="mb-10 flex flex-wrap items-center justify-between gap-x-4 gap-y-3 sm:mb-12"><Link href="/"><Lockup size={34} /></Link><Link href="/" className="font-mono text-[0.75rem] text-muted underline decoration-line underline-offset-4 hover:text-ink">← back</Link></header>
      <h1 className="mb-3 font-display text-[1.9rem] font-bold leading-tight tracking-[-0.03em] sm:text-[2.25rem] sm:tracking-[-0.035em]">Enter LinkedOut</h1>
