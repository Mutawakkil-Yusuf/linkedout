    ...
    <div className="mx-auto max-w-[44rem] px-5 py-14">
      ...
      <section className="pt-20 pb-16">
        <div className="mb-6 inline-flex items-center gap-2 rounded-[10px] bg-flame/10 px-3 py-1.5 font-mono text-[0.7rem] font-medium uppercase tracking-[0.1em] text-flame-deep">
          For people, not positions
        </div>
        <h1 className="mb-6 font-display text-[3.15rem] font-bold leading-[1.02] tracking-[-0.04em]">
      ...
      <section className="border-t border-line pt-14">
        <h2 className="mb-6 max-w-[28rem] font-display text-[2rem] font-bold leading-[1.1] tracking-[-0.03em]">You are not inventory. Come be a person for a while.</h2>
